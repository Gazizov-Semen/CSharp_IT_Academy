    ...
    public class Actions
    {
        ...
        public static void EnrollStudent()
        {
            ...
            if (courses.TryGetValue(name, out var course))
            {
                ...
                educationService.AddStudent(student.Name); // Сохранить студента в базу данных
                ...
                if (courses.TryGetValue(name, out var course))
                {
                    ...
                    if (student != null)
                    {
                        ...
                        if (int.TryParse(Console.ReadLine(), out int subjectIndex) && subjectIndex >= 1 && subjectIndex <= subjects.Length)
                        {
                            ...
                            {
                                student.Grades.Add(new Grade(grateId, subject, score));
                                educationService.AddGrade(student.Id, subject, score); // Сохраняем оценку в базу данных
